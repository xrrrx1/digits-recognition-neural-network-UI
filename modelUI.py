...
root = Tk()
root.resizable(0, 0)
root.title("MISIS project for Ivan")
...
btn_save = Button(text='PREDICT', width=15,
                  height=3, command=Recognize_Digit)
btn_save.grid(row=2, column=0, pady=1, padx=1)
button_clear = Button(text='CLEAR', width=15,
                      height=3, command=clear_widget)
